...
- (id) initWithFrame:(CGRect)frame captureSession:(AVCaptureSession *)captureSession
{
    ...
    if ( self ) {
        ...
        if ( captureSession ) {
            ...
            [_previewLayer setFrame:CGRectMake(0, 65, [[UIScreen mainScreen] bounds].size.width, [[UIScreen mainScreen] bounds].size.height - 140) ];
        } else
...
- (void) defaultInterface
{
    ...
    imageView = [[UIImageView alloc] initWithFrame:_previewLayer.frame];
    [imageView setAutoresizingMask:UIViewAutoresizingFlexibleHeight];
    [imageView setContentMode:UIViewContentModeScaleToFill];
    [imageView setImage:[UIImage imageNamed:_pic]];
...
- (UIButton *) closeButton
{
    if ( !_closeButton ) {
        ...
        [_closeButton setFrame:(CGRect){ CGRectGetMidX(self.bounds) - 25, 7.5f, 50, 50 }];
...
- (UIButton *) cameraButton
{
    if ( !_cameraButton ) {
        ...
        [_cameraButton setFrame:(CGRect){ 5, 7.5f, 50, 50 }];
...
- (UIButton *) flashButton
{
    if ( !_flashButton ) {
        ...
        [_flashButton setFrame:(CGRect){ CGRectGetWidth(self.bounds) - 55, 7.5f, 50, 50 }];
